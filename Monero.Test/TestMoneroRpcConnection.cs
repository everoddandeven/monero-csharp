...
namespace Monero.Test
{
    public class TestMoneroRpcConnection
    {
        ...
        // Can connect with HTTPS
        [Fact]
        public void TestHttpsConnection()
        {
            var connection = new MoneroRpcConnection("https://xmr-node.cakewallet.com:18081");
        ...
        {
            var connection = new MoneroRpcConnection("http://xmr-de.boldsuck.org:18081");

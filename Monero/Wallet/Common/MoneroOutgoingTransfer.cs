...
namespace Monero.Wallet.Common
{
    public class MoneroOutgoingTransfer : MoneroTransfer
    {
        ...
        public bool Equals(MoneroOutgoingTransfer? other)
        {
            ...
            {
                if (other._subaddressIndices == null) return false;
                if (_subaddressIndices.Count != other._subaddressIndices.Count) return false;
                int i = 0;
            ...
            if (_addresses == null)
            {
                if (other._addresses != null) return false;
            }
            else
            {
                if (other._addresses == null) return false;
                if (_addresses.Count != other._addresses.Count) return false;
                int i = 0;
            ...
            {
                if (other._destinations == null) return false;
                if (_destinations.Count != other._destinations.Count) return false;

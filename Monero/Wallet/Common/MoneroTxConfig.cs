...
public class MoneroTxConfig
{
    ...
    public bool Equals(MoneroTxConfig? other)
    {
        ...
        {
            if (other._destinations == null || _destinations.Count != other._destinations.Count)
            {
                return false;
            }
            ...
            {
                if (!dest.Equals(other._destinations[i]))
                {
                    return false;
                }
                i++;
        ...
        {
            if (other._subtractFeeFrom != null)
            {
                return false;
            }
        }
        else
        {
            ...
            {
                if (fee != other._subtractFeeFrom[i])
                {
                    return false;
                }
                i++;
        ...
        else
        {
            ...
            {
                if (index != other._subaddressIndices[i])
                {
                    return false;
                }
                i++;

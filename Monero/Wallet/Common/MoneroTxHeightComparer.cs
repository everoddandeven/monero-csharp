...
namespace Monero.Wallet.Common
{
    internal class MoneroTxHeightComparer : Comparer<MoneroTx>
    {
        public override int Compare(MoneroTx? tx1, MoneroTx? tx2)
        {
            ...
            if (height1 == null) return 1;   // tx1 is unconfirmed
            if (height2 == null) return -1;  // tx2 is unconfirmed
            if (height1 < height2) return -1; // tx1 is earlier
            if (height1 > height2) return 1;  // tx2 is earlier
